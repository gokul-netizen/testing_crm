  ...
  return (
    <div className="flex justify-center">
      <button
        ...
        aria-live="polite"
        className={`relative   cursor-pointer overflow-hidden    bg-background p-2 focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 disabled:opacity-50 ${className}`}
