...
export default function Page() {
  ...
  const { domainId , inquiryId } = params;

 
  const domainID = domainId as string;
  const inquiryID = inquiryId as string;
        ...
        <div className='flex flex-col gap-4 md:flex-row items-center justify-between mx-4' >
          ...
          <CustomBreadcrumb
            paths={[
              ...
              { label: "Records", href: `/sub-user/inquiry/view/${domainID}/` },
         ...
         {followup ? <OverView back={`/sub-user/inquiry/view/${domainId}`} id={inquiryID} /> : <SubUserTimeLine url={`/sub-user/inquiry/view/${domainId}`}     domainId={domainID} inquiryId={inquiryID} />}
