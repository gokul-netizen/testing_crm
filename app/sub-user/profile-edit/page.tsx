...
export default function Page() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            const res = await fetch(`/api/sub-user`, {
                method: "PUT",
                credentials: "include",
                body: form,
            });
            ...
            if (res.ok) {
                ...
                route.push(`/sub-user/profile`);
                mutate(`/sub-user/profile`)
        ...
        <section>
            <div>
                <div className="flex gap-4">
                    <Link
                        href={`/sub-user/profile`}
                        className={`flex items-center gap-2 px-6 py-2 rounded-md text-gray-600 hover:bg-purple-100 ${isActive(`/user/profile`) ? "bg-[#7367f0] text-white" : ""
                            }`}
                    >
                        <LuUsers size={20} />
                    ...
                    <Link
                        href={`/sub-user/profile-edit`}
                        className={`flex items-center gap-2 px-6 py-2 rounded-md ${isActive(`/sub-user/profile-edit`) ? "bg-[#7367f0] text-white" : ""
                            }`}
                    >
                        <LuUsers size={20} />
