    ...
    const columns: Column<DataItem>[] = [
        {
            ...
            accessor: (item) => (
                <div className="flex items-center gap-2 group">
                    <Link href={`/sub-user/assigned-followups/${item.id}`}><span className="truncate">{item?.name}</span></Link>
        ...
        },
        {
            ...
            accessor: (item) => (
                item?.phone ? (<div className="flex items-center gap-2 group">
                    <Link href={`/sub-user/assigned-followups/${item.id}`}>
        ...
        <section>
            ...
            <div >
                <DataTableComponent
                    ...
                    detail={(item) => `/sub-user/assigned-followups/${item.id}`}
