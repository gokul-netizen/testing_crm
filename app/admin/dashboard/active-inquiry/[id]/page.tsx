...
export default function Page() {
    ...
    return (
        <section className="px-3">
            ...
            <div className="flex justify-end py-2 px-3">
                <CustomBreadcrumb
                    paths={[
                        ...
                        { label: "Active Inquiries", href: `/admin/dashboard/active-inquiry` },
            ...
            {followup ? <OverView back={`/admin/dashboard/active-inquiry`} id={id} /> : <TimeLineAdminSide id={id} userId={2} />}
        </section>
    )
}