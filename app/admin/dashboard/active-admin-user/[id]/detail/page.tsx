    ...
    return (
        <section className="px-3">
            <div className="flex justify-end py-2 px-3">
                <CustomBreadcrumb
                    paths={[
                        ...
                        { label: "Active Admin User", href: `/admin/dashboard/active-admin-user` },
            ...
            <div className="bg-white p-8 rounded-md shadow-[0_0_20px_rgba(0,0,0,0.15)] space-y-6">
                            ...
                            Object.entries(detailData).map(([key, value]) => (
                                ...
                                >
                                    ...
                                    <p className="text-gray-700 mt-1">
                                        {key === "added_on" || key === "joining_date" ? dayjs(String(value)).utc().format("DD-MM-YYYY hh:mm A") : String(value)}
                ...
                <Link
                    href={`/admin/dashboard/active-admin-user/`}
