...
export default function Page() {
    ...
    return (
        <section className="px-3">
            ...
            <div className="flex justify-end py-2 px-3">
                <CustomBreadcrumb
                    paths={[
                        ...
                        { label: "todays follow up", href: `/admin/dashboard/todays-followup` },
            ...
            {followup ? <OverView back={`/admin/dashboard/todays-followup`} id={id} /> : <TimeLineAdminSide id={id} userId={2} />}
        </section>
    )
}