    ...
    const handleSubmit = async () => {
        try {
            ...
            if (callVisit === "Visit" && reminderTime) {
                ...
                if (targetDate) {
                    reminder = `${targetDate}T${reminderTime.format("HH:mm:ss")}Z`;
                } else {
            ...
            if (callVisit === "Visit" && reminderTime) {
                reminder = followUp.includes("Assign To")
                    ? `${assignDate}T${reminderTime.format("HH:mm:ss")}Z`
                    : `${date}T${reminderTime.format("HH:mm:ss")}Z`;
            }
