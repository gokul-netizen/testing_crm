        ...
        <section>
            <div>
                ...
                <div className="flex gap-4">
                    <Link
                        href={`/user/profile`}
                        className={`flex items-center gap-2 px-6 py-2 rounded-md text-gray-600 hover:bg-purple-100 ${isActive(`/user/${user_id}/profile`) ? "bg-[#7367f0] text-white" : ""
                            }`}
                    >
                        <LuUsers size={20} />
                    ...
                    <Link
                        ...
                        className={`flex items-center gap-2 px-6 py-2 rounded-md ${isActive(`/user/profile/edit`) ? "bg-[#7367f0] text-white" : ""
                            }`}
                    >
                        <LuUsers size={20} />
                ...
                <div className="bg-white shadow-xl rounded-md p-8 my-6">
                    ...
                    <div className="rounded mb-4 flex gap-8 items-center">
                            ...
                            <img
                                src={previewImage ? previewImage : formData?.image ? `/${formData.image.replace(/\\/g, "/")}` : '/admin_profile.webp' }
                                alt={data?.username}
                                className="w-28 h-28"
                            />
