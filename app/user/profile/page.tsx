        ...
        <section className=" flex flex-col-reverse lg:flex-row  items-start gap-4">
            ...
            <div className="bg-white shadow-xl rounded-md w-full lg:w-[40%] p-8 border border-gray-100">
                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-3 text-[16px] text-gray-500">
                        ...
                        <p><span className="font-bold text-gray-600">last_login: </span> {dayjs(data?.last_login).format("DD-MM-YYYY hh : mm A")}</p>
                ...
                <div className="flex gap-4 mt-10">
                    <Link href={`/user/profile/edit`} className="flex-1 bg-[#7C69EF] hover:bg-[#6a56e0] text-white font-bold py-3 flex items-center justify-center rounded-lg transition-all shadow-md shadow-indigo-100">
                        Edit
                    </Link>
                    <button className="flex-1 cursor-pointer bg-red-50 hover:bg-red-100 text-red-400 font-bold py-3 rounded-lg transition-all border border-red-100">
                        Suspend
                    </button>
                    <Link href={`/user`} className="flex justify-center px-5 cursor-pointer bg-[#00BDD6] hover:bg-[#00a8bf] text-white font-bold py-3 rounded-lg transition-all shadow-md shadow-cyan-100">
                        Back ←
                    </Link>
                </div>
            </div>
            ...
            <div >
                <div className="flex  gap-4 ">
                    ...
                    <Link href={`/user/profile/edit`} className={`flex items-center gap-2 px-6 py-2 rounded-md  text-gray-500 hover:bg-[#cecbec]`}
                    >
                        <LuUsers size={20} />
