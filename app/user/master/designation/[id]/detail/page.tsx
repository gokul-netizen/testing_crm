...
export default function Page(){
    ...
    const { data, error, isLoading } = useSWR(`/api/designation/${id}`, fetcher);
  ...
  },
  {
    ...
    <div className="p-4 flex justify-center">
      <div className="w-full  bg-white rounded-lg shadow-xl p-6">
        <h1 className="text-xl text-gray-600 font-medium mb-6 text-center lg:flex lg:justify-start">Designation Detail</h1>
